export class niveau3 extends Phaser.Scene {
    ...
    preload() { // préchargement des assets
        ...
        this.load.tilemapTiledJSON('niveau3', 'tiled/level3_zelda.json'); // import fichier tiled
    ...
    create() { // Création des éléments dès l'initialisation du jeu
        ...
        this.map1 = this.add.tilemap('niveau3');
        ...
        this.physics.world.setBounds(0, 0, 960, 640); // Défini les limites où le joueur peut aller
        this.cameras.main.setBounds(0, 0, 960, 640); // Défini les limites de la caméra (début x, début y, fin x, fin y)
    ...
    update() {
        ...
        if (this.lifePlayer <= 0) {
            this.lifePlayer = 6;
            //this.gameOver = true;
            this.scene.start('niveau3', { entrance: 'niveau3', lifePlayer : this.lifePlayer }) // reset
        }
   ...
   /* jump(poids, blocCible) {
    ...
    spawn_mobs() {
        ...
        this.mobs.create(320, 256, 'marcheSamurai').anims.play('mobGauche', true);
        this.mobs.create(480, 224, 'marcheSamurai').anims.play('mobGauche',true);
        this.mobs.create(640, 288, 'marcheSamurai').anims.play('mobGauche',true);
        this.mobs.create(800, 256, 'marcheSamurai').anims.play('mobGauche',true);
